...
public class AdminMenu {
	...
	//
	/*
	 * public void bookManipulation() throws SQLException, ClassNotFoundException,
	 * IOException {
	 ...
	 * 
	 * while (selection < 1 || selection > 4) {
	 * System.out.println("Invalid selection. Try again: "); selection =
	 * Integer.parseInt(reader.readLine()); }
	 * 
	 * if (selection == 1) { System.out.println("Enter the Book name: "); String
	 * bookName = reader.readLine(); Book book = new Book();
	 * book.setBookName(bookName); adminService.addBook(book);
	 * System.out.println("\n"); level1(); } if (selection == 3) {
	 * System.out.println("Enter the ID of the Book you would like to delete: ");
	 * 
	 * for (Book a : adminService.readAllBooks()) { System.out.println(a.getBookId()
	 * + ") " + a.getBookName()); } Integer bookId =
	 * Integer.parseInt(reader.readLine()); while
	 * (!adminService.checkBookId(bookId)) {
	 * System.out.println("That Book doesn't exist. Try again."); bookId =
	 * Integer.parseInt(reader.readLine()); } Book book = new Book();
	 * book.setBookId(bookId); adminService.deleteBook(book);
	 * System.out.println("\n"); level1(); }
	 * 
	 * if (selection == 2) {
	 ...
	 * 
	 * System.out.println("Enter the new name of the Book: "); String newBook =
	 * reader.readLine(); book.setBookName(newBook); adminService.updateBook(book);
	 * System.out.println("\n"); level1(); }
	 * 
	 * if (selection == 4) { System.out.println("Here is a list of the Books"); for
	 * (Book a : adminService.readAllBooks()) { System.out.println(a.getBookId() +
	 * ") " + a.getBookName()); } System.out.println("\n"); level1(); } }
	 */
